...
(function dartProgram() {
  ...
  F = {
    main: function() {
      ...
      vaihtoehdot.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "En tied\xe4", "oikein", false], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Toimiiko?", "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Futaako?", "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Lataako?", "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Nyt stop?", "vaihtoehdot", vaihtoehdot], t1, t2));
      kysymykset.push(P.LinkedHashMap_LinkedHashMap$_literal(["teksti", "Viel\xe4kin?", "vaihtoehdot", vaihtoehdot], t1, t2));
      t2 = J.get$onClick$x(document.querySelector("#nappi"));
      t1 = t2.$ti;
